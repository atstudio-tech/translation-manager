...
<div class="max-w-6xl mx-auto">
    <header class="flex items-center">
        ...
        <button class="ml-auto px-4 py-2 uppercase text-teal-50 dark:text-teal-900 inline-flex gap-3 items-center bg-teal-500 shadow-md rounded-full font-semibold text-sm tracking-wider transition duration-300 hover:bg-teal-600 group">
